...
namespace AuctionApp.Migrations
{
    ...
    [Migration("20180731190801_ModifyingCaptionLengthAgain")]
    partial class ModifyingCaptionLengthAgain
    {
            ...
            modelBuilder.Entity("AuctionApp.Entities.ArtWork", b =>
                {
                    b.HasOne("AuctionApp.Entities.Author", "Author")
                        .WithOne("ArtWork")
                        .HasForeignKey("AuctionApp.Entities.ArtWork", "AuthorId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AuctionApp.Entities.Category", "Category")
                        .WithOne("ArtWork")
                        .HasForeignKey("AuctionApp.Entities.ArtWork", "CategoryId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
